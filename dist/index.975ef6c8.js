...
var _indexCss = require("./sass/index.css");
...
const fetchImages = ()=>{
    ...
    (0, _axiosDefault.default).get(url).then((response)=>{
        ...
        if (hits.length < 40 || gallery.children.length === totalHits) {
            ...
            (0, _notiflixDefault.default).Notify.success("Congratulations, you have reached the end of the search results!");
        } else loadMoreBtn.style.display = "block";
    }).catch((error)=>{
        (0, _notiflixDefault.default).Notify.failure("Oops, something went wrong. Please try again later.");
    });
};
...
const handleSearchFormSubmit = (e)=>{
    ...
    loadMoreBtn.style.display = "none";
    if (searchQuery === "") {
        (0, _notiflixDefault.default).Notify.warning("Please enter a search query.");
        return;
    }
    fetchImages();
};
...
},{"./sass/index.css":"hVeg4","notiflix":"5z0Oc","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg","axios":"jo6P5","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hVeg4":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"1IPtg":[function() {},{}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var Buffer = require("96a7dfdfd5dbb4a2").Buffer;
"use strict";
/**
...
},{"96a7dfdfd5dbb4a2":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("9634dd55a208b3b3");
var ieee754 = require("4e82edd55fe8a183");
...
},{"9634dd55a208b3b3":"eIiSV","4e82edd55fe8a183":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{}],"kaxSc":[function() {},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequired7c6")
